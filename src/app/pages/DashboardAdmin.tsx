    ...
    try {
      ...
      setUsersData(
        usersResult.users.map((user: any) => ({
          ...
          orders: Number(user.total_orders_as_buyer) || 0,
      ...
      setSellersData(
        sellerResult.users.map((seller: any) => ({
          ...
          services: Number(seller.total_services) || 0,
          orders: Number(seller.total_orders_as_seller) || 0,
          earnings: Number(seller.total_revenue) || 0,
          rating: (seller.rating !== null && seller.rating !== undefined) ? Number(seller.rating).toFixed(1) : '-',
